...
<head>
    ...
    <title>Blank Page | {{ config('app.name') }}</title>
...
<body class="sidebar-mini layout-navbar-fixed" style="height: auto;">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header"><strong>Admin</strong></span>
                        <span class="dropdown-item dropdown-header">admin@example.com</span>
                        <div class="dropdown-divider"></div>
                        {{-- <a href="#" class="dropdown-item">
                            <i class="fas fa-envelope mr-2"></i> 4 new messages
                            <span class="float-right text-muted text-sm">3 mins</span>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright © 2025 <a href="{{ url('/') }}">{{ config('app.name') }}</a>.</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
